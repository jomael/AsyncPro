...
//
//  TModemName     = string;                            {!!.03}
//  TCmdString     = string;                            {!!.03}
//  TRspString     = string;                            {!!.03}
//  TTagString     = string;                            {!!.03}
//  TTagProfString = string;                            {!!.03}
//  TConfigString  = string;                            {!!.03}
//  TBoolStr       = string;                            {!!.03}
//  TBaudStr       = string;                            {!!.03}
// END BAV MOD
...
{TApdCustomModemDBase}
  ...
  begin
    ...
    if OpenIt then begin
      if FOpen then
        FreeElement;
      CheckException(Self, mInitModemDatabase(DB, StrPCopy(Temp, AnsiString(FFileName))));
    end else
      if FOpen then
        FreeElement;
  ...
  var
	...
	begin
		...
		CheckException(Self, mWriteToIni(DB, Scratch, StrPCopy(TempSec, AnsiString(Section)), StrPCopy(TempIni, AnsiString(IniFile))));
	end;
	...
	begin
		...
		CheckException(Self, mReadFromIni(DB, Scratch, StrPCopy(TempSec,AnsiString(Section)),
									StrPCopy(TempIni, AnsiString(IniFile))));
