...
//    ConfigVersion : string[8];       { version tag to support future features }
    ConfigVersion : string;       { version tag to support future features }
    { port settings }
...
function TAdCustomModem.FailureCodeMsg(const FailureCode: Integer): string;
...
function TAdCustomModem.ModemLogToString(LogCode: TApdModemLogCode): string;
...
procedure TAdCustomModem.ResponseStringPacket(Sender: TObject; Data: string);
var
  Res : Integer;
begin
