...
type
  ...
  TProcessCharProcLo = procedure(PAnsiEmulator: Pointer; C: AnsiChar;
...
procedure aeProcessAnsiChar(P : Pointer; C : AnsiChar;
                            var Command : TEmuCommandLo);
...
const
  ...
  procedure aePutQueue(P : PAnsiEmulator; C : AnsiChar);
    {-Save characters}
  begin
    with P^ do begin
  ...
  procedure aeBuildParam(P : PAnsiEmulator; C : AnsiChar);
    {-Build a param string}
  begin
    with P^ do
      emuParamStr[emuParamIndex] := emuParamStr[emuParamIndex] + string(C);
  end;

  procedure aeConvertParams(P : PAnsiEmulator; C : AnsiChar);
  ...
  procedure aeMakeCommand(P : PAnsiEmulator; C : AnsiChar; var Command : TEmuCommandLo);
