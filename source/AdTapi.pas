...
type
  ...
  public
    ...
    function  TranslateDialog( const CanonicalAddr : ansistring) : Boolean;
...
{TApdCustomTapiDevice}
  ...
  begin
	...
	begin
		...
		SelectedLine    := -1;
		RetryPending    := False;
		FillChar(LineExt, SizeOf(LineExt), 0); 	//Baz - fill char OK here
		FDialTime       := 0;
		PassThruMode    := False;
...
Var
  ...
  function TApdCustomTapiDevice.TranslateDialog( const CanonicalAddr : ansistring) : Boolean;
  begin
