...
{ +CMS ERROR: message Service Failure Result Code }
procedure TApdCustomGSMPhone.ErrorStringPacket(Sender: TObject; Data: string);
var
  ErrorCode : Integer;
  ErrorMessage : string;
  Temp : string;
    ...
    gsSend: begin
              ...
              if CmdIndex > High(GSMSendMessageResponse) then begin
                ...
                if CmdIndex = High(GSMSendMessageCommands) - 1 then begin
                  ...
                  FComPort.Output := 'AT' + GSMSendMessageCommands[CmdIndex] + STemp + #13;                   {!!.06}
                end else begin
