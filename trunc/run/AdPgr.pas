...
type
  ...
  TApdPgrLog = class(TPersistent)
    ...
    public
      ...
      procedure AddLogString(Verbose : Boolean; const StatusString : string);
      procedure ClearLog;
    published
...
procedure TApdCustomPager.DoServerFatalError(Sender: TObject; Data: string);
...
procedure TApdPgrLog.AddLogString(Verbose: Boolean; const StatusString: string);
  ...
  if FEnabled then
    if Verbose and FVerboseLog then begin
      ...
      TimeStamp := FormatDateTime('dd/mm/yy : hh:mm:ss - ', Now) + ' ' +
                   ...
                   string(DestAddr) + string(StatusString) + #13#10;
