...
const
  ...
  {Limits}
  MaxCountries = 1000;
  TapiLowVer   = $00010004;     // 1.4
  TapiHighVer  = $00020002;     // 2.2
...
{Memory handling wrappers}
  ...
  function tuLineTranslateAddressDyn(Line : TLine;
                                     DeviceID : DWORD;
                                     APIVersion : DWORD;
                                     const AddressIn : ansistring; Card : DWORD;
                                     TranslateOptions : DWORD;
  ...
  function tuLineTranslateDialog(Line : TLine; DeviceID : DWORD;
                                 APIVersion : DWORD; HwndOwner : HWND;
                                 const AddressIn : ansistring) : LongInt;
...
const
 TAPI_CallSuffix = 'A'; // 'A' for ansi; 'W' for UCS-2; and '' for compiler dependant.
...
{TAPI routines}
  ...
  function tuLineInitialize(
    var LineApp : TLineApp;
    Instance : THandle;
    Callback : TLineCallback;
    AppName : PAnsiChar;
    var NumDevs : DWORD) : LongInt;
