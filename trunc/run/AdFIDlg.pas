...
type
  ...
  public
    ...
    function ShowDialog (JobFileName, DlgCaption: string): TModalResult;
  end;
...
function TApdFaxJobInfoDialog.ShowDialog(JobFileName, DlgCaption: string): TModalResult;
begin
  Caption := DlgCaption;
  SetDirty(False);
  ...
  try
    ...
    if ModalResult = mrOK then begin
      try
        try
          JobStream := TFileStream.Create(string(JobFileName), fmOpenWrite or fmShareDenyWrite);
