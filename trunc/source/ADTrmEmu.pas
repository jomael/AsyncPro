...
type                          
  ...
  TAdCustomTerminal = class(TApdBaseWinControl)
    ...
    public
      ...
      procedure WriteStringSource(const aSt : string; Source:TAdCharSource);// SWB
...
{--------}                                                                  // SWB
procedure TAdCustomTerminal.WriteStringSource(const aSt : string;           // SWB
                                              Source:TAdCharSource);        // SWB
begin                                                                       // SWB
  {stuff the data into the byte queue}                                      // SWB
...
{--------}
procedure TAdTerminalEmulator.KeyPress(var Key : AnsiChar);
begin
  {do nothing}
end;
{--------}
...
{--------}
procedure TAdTTYEmulator.KeyPress(var Key : AnsiChar);
begin
  {send it to the host}
  if (Key = ^H) then
    Key := #127;
...
{--------}
procedure TAdVT100Emulator.KeyPress(var Key : AnsiChar);
begin
