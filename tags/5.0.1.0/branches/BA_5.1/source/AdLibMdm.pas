...
begin
  ...
  try
    ...
    try
			Parser.ParseDataSource (AddBackSlash (FLibModemPath) + 'modemcap.xml');
...
begin
  ...
  try
    ...
    try
      Parser.ParseDataSource(AddBackSlash(FLibModemPath) + FileName);
...
function TApdLibModem.GetXMLBoolean(Value: string; Default: Boolean): Boolean;
begin  
  Result := Default;
...
function TApdLibModem.GetXMLInteger(Value: string;  Default: Integer): Integer;
begin
...
function TApdLibModem.CreateNewDetailFile(const ModemDetailFile: string): Integer;
  { create a new modem detail file with appropriate headers }
var
...
function TApdLibModem.AddModem(const ModemDetailFile: string;  Modem: TLmModem): Integer;
...
function TApdLibModem.GetModem(const ModemDetailFile, ModemName: string; var Modem : TLmModem) : Integer;
  { retrieves a specific modem from the modem detail file }
var
  I : Integer;
begin
