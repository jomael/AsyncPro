...
type
  TForm1 = class(TForm)
    ...
    procedure ApdComPort1TriggerLineError(CP: TObject; Error: Word;
      LineBreak: Boolean);
  private
    FStatusTrigger  : Word;
  public
...
procedure TForm1.ApdComPort1TriggerLineError(CP: TObject; Error: Word;
  LineBreak: Boolean);
begin
    ShowMessageFmt('Line error.'#10'Error = %d.'#10'Win Error = %d.',
                   [Error, ApdComPort1.LastWinError]);
    ApdComPort1.SetStatusTrigger(FStatusTrigger,
                                 lsOverrun or lsParity or lsFraming or lsBreak,
                                 True);
end;
